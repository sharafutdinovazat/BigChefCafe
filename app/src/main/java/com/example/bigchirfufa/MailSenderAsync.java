...
class MailSenderAsynс extends AsyncTask<String, Void, Void>
{
...
class MailSender extends javax.mail.Authenticator{
    ...
    public synchronized void sendMail(String subject, String body, String sender, String recipients) throws Exception {
        try{
            ...
            //Toast.makeText(MainActivity.getAppContext(), "Вы сделали покупку, заказ отправляется", Toast.LENGTH_SHORT).show();
        }catch(Exception e){
            e.printStackTrace();
        }
    }
